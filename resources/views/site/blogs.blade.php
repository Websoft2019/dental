			...
			<div class="row align-items-center">
				<div class="col-lg-12">
					...
					<div class="page-header-box">
						<h1 class="text-anime-style-2" data-cursor="-opaque"><span>Blogs</span></h1>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="blog-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <div class="post-featured-image" data-cursor-text="View">
                            <figure>
                                <a href="#" class="image-anime">
                                    <img src="{{ asset('site/images/post-4.jpg') }}" alt="">
                                </a>
                            </figure>
                        </div>
                        <!-- Post Featured Image End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="blog-item wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <div class="post-featured-image" data-cursor-text="View">
                            <figure>
                                <a href="#" class="image-anime">
                                    <img src="{{ asset('site/images/post-5.jpg') }}" alt="">
                                </a>
                            </figure>
                        </div>
                        <!-- Post Featured Image End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="blog-item wow fadeInUp" data-wow-delay="1s">
                        ...
                        <div class="post-featured-image" data-cursor-text="View">
                            <figure>
                                <a href="#" class="image-anime">
                                    <img src="{{ asset('site/images/post-6.jpg') }}" alt="">
                                </a>
                            </figure>
                        </div>
                        <!-- Post Featured Image End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="blog-item wow fadeInUp" data-wow-delay="1.2s">
                        ...
                        <div class="post-featured-image" data-cursor-text="View">
                            <figure>
                                <a href="#" class="image-anime">
                                    <img src="{{ asset('site/images/post-7.jpg') }}" alt="">
                                </a>
                            </figure>
                        </div>
                        <!-- Post Featured Image End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="blog-item wow fadeInUp" data-wow-delay="1.4s">
                        ...
                        <div class="post-featured-image" data-cursor-text="View">
                            <figure>
                                <a href="#" class="image-anime">
                                    <img src="{{ asset('site/images/post-8.jpg') }}" alt="">
                                </a>
                            </figure>
                        </div>
                        <!-- Post Featured Image End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="blog-item wow fadeInUp" data-wow-delay="1.6s">
                        ...
                        <div class="post-featured-image" data-cursor-text="View">
                            <figure>
                                <a href="#" class="image-anime">
                                    <img src="{{ asset('site/images/post-9.jpg') }}" alt="">
                                </a>
                            </figure>
                        </div>
                        <!-- Post Featured Image End -->
