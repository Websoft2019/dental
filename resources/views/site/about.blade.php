                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="company-logo">
                                        <img src="{{ asset('site/images/client-logo-1.svg') }}" alt="">
                                    </div>
                                </div>
                                <!-- company Logo End -->
                                ...
                                <div class="swiper-slide">
                                    <div class="company-logo">
                                        <img src="{{ asset('site/images/client-logo-2.svg') }}" alt="">
                                    </div>
                                </div>
                                <!-- company Logo End -->
                                ...
                                <div class="swiper-slide">
                                    <div class="company-logo">
                                        <img src="{{ asset('site/images/client-logo-3.svg') }}" alt="">
                                    </div>
                                </div>
                                <!-- company Logo End -->
                        ...
                        <div class="dental-process-image">
                            <div class="dental-process-img">
                                <figure class="image-anime">
                                    <img src="{{ asset('site/images/dental-process-img-1.jpg') }}" alt="">
                                </figure>
                            </div>
                    ...
                    <!-- Dental Process Item Start -->
                     <div class="dental-process-item wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="dental-process-image">
                            <div class="dental-process-img">
                                <figure class="image-anime">
                                    <img src="{{ asset('site/images/dental-process-img-2.jpg') }}" alt="">
                                </figure>
                            </div>
                    ...
                    <!-- Dental Process Item Start -->
                     <div class="dental-process-item wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="dental-process-image">
                            <div class="dental-process-img">
                                <figure class="image-anime">
                                    <img src="{{ asset('site/images/dental-process-img-3.jpg') }}" alt="">
                                </figure>
                            </div>
                    ...
                    <!-- Dental Process Item Start -->
                     <div class="dental-process-item wow fadeInUp" data-wow-delay="0.75s">
                        ...
                        <div class="dental-process-image">
                            <div class="dental-process-img">
                                <figure class="image-anime">
                                    <img src="{{ asset('site/images/dental-process-img-4.jpg') }}" alt="">
                                </figure>
                            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="expertise-experience-img">
                            <figure class="image-anime reveal">
                                <img src="{{ asset('site/images/expertise-experience-img.jpg') }}" alt="">
                            </figure>
                        </div>
