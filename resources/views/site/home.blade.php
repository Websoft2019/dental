...
<!-- Hero Section Start -->
    <div class="hero bg-image hero-video">
		...
		<div class="hero-bg-video">
            ...
            <video autoplay muted loop id="myVideo"><source src="https://demo.awaikenthemes.com/assets/videos/dentaire-video.mp4" type="video/mp4"></video>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="hero-content">
                        ...
                        <div class="section-title">
                            ...
                            <h1 class="text-anime-style-2" data-cursor="-opaque">Creating Beautiful Smiles Every Day</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="cta-box-item wow fadeInUp">
                        <div class="icon-box">
                            <img src="{{ asset('site/images/icon-cta-phone.svg') }}" alt="">
                        </div>
                        <div class="cta-box-content">
                            <h3>need dental services ?</h3>
                            <p>Call on : (+977) 61 588358</p>
                        </div>
                    </div>
                </div>
                <!-- Cta Box Item End -->
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="cta-box-item wow fadeInUp" data-wow-delay="0.25s">
                        <div class="icon-box">
                            <img src="{{ asset('site/images/icon-cta-time.svg') }}" alt="">
                        </div>
                        <div class="cta-box-content">
                            <h3>opening hours</h3>
                    ...
                    <div class="about-image">
                        <div class="about-img-1">
                            <figure class="image-anime reveal">
                                <img src="{{ asset('site/images/about-us-img-1.jpg') }}" alt="">
                            </figure>
                        </div>

                        <div class="about-img-2">
                            <figure class="image-anime reveal">
                                <img src="{{ asset('site/images/about-us-img-2.jpg') }}" alt="">
                            </figure>
                        </div>
                        ...
                        <div class="about-experience">
                            <figure>
                                <img src="{{ asset('site/images/about-experience-circle.png') }}" alt="">
                            </figure>
                        </div>
    ...
    <div class="our-services">
        ...
        <div class="icon-star-image">
            <img src="{{ asset('site/images/icon-star.svg') }}" alt="">
        </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="how-it-work-img">
                        <figure class="reveal image-anime">
                            <img src="{{ asset('site/images/how-it-work-img.jpg') }}" alt="">
                        </figure>
                    </div>
                    ...
                    <div class="how-it-work-content">
                        ...
                        <div class="faq-accordion how-work-accordion" id="accordion">
                            ...
                            <div class="accordion-item wow fadeInUp">
                                <div class="icon-box">
                                    <img src="{{ asset('site/images/icon-how-it-work-1.svg') }}" alt="">
                                </div>
                            ...
                            <div class="accordion-item wow fadeInUp" data-wow-delay="0.25s">
                                <div class="icon-box">
                                    <img src="{{ asset('site/images/icon-how-it-work-2.svg') }}" alt="">
                                </div>
                            ...
                            <div class="accordion-item wow fadeInUp" data-wow-delay="0.5s">
                                <div class="icon-box">
                                    <img src="{{ asset('site/images/icon-how-it-work-3.svg') }}" alt="">
                                </div>
            ...
            <div class="row">
                    ...
                    <div class="team-member-item wow fadeInUp">
                        ...
                        <div class="team-image">
                            <figure class="image-anime">
                                <img src="{{ asset('site/images/team-1.jpg') }}" alt="">
                            </figure>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="team-member-item wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="team-image">
                            <figure class="image-anime">
                                <img src="{{ asset('site/images/team-2.jpg') }}" alt="">
                            </figure>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="team-member-item wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="team-image">
                            <figure class="image-anime">
                                <img src="{{ asset('site/images/team-3.jpg') }}" alt="">
                            </figure>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="team-member-item wow fadeInUp" data-wow-delay="0.75s">
                        ...
                        <div class="team-image">
                            <figure class="image-anime">
                                <img src="{{ asset('site/images/team-4.jpg') }}" alt="">
                            </figure>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="blog-item wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="post-featured-image" data-cursor-text="View">
                            <figure>
                                <a href="#" class="image-anime">
                                    <img src="{{ asset('site/images/post-2.jpg') }}" alt="">
                                </a>
                            </figure>
                        </div>
                        <!-- Post Featured Image End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="blog-item wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="post-featured-image" data-cursor-text="View">
                            <figure>
                                <a href="#" class="image-anime">
                                    <img src="{{ asset('site/images/post-3.jpg') }}" alt="">
                                </a>
                            </figure>
                        </div>
                        <!-- Post Featured Image End -->
